...
f = [lambda _x, _y: math.tan(_x * _y + m) - _x, lambda _x, _y: a * _x ** 2 + 2 * _y ** 2 - 1]

g = [lambda x, y: math.tan(x * y + m), lambda x, y: math.sqrt(0.5 * (1 - a * x ** 2))]
...
# 0.5, 0.5 - начальное приближение, место старта
