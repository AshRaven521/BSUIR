...
namespace ConsoleApp1
{
    public class LexicalAnalizer
    {
        ...
        {
            if (ReservedIDs.TryGetValue(value, out TokenTypes tokenType)
        ...
        {
            if (SimpleOperators.TryGetValue(value, out TokenTypes tokenType) || BlockOpeningOperators.TryGetValue(value, out tokenType))
            {
                return tokenType;
            }
            return TokenTypes.UNKNOWN;
