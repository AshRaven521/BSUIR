...
public class TCP {
    ...
    static TCP from_string(String s) {
        ...
        return obj.with_source_port(Integer.parseInt(s.split(" ")[0], 10))
                ...
                .with_urg(s.split(" ")[4].charAt(0) - 48)
                .with_ack(s.split(" ")[5].charAt(0) - 48)
                .with_psh(s.split(" ")[6].charAt(0) - 48)
                .with_rst(s.split(" ")[7].charAt(0) - 48)
                .with_syn(s.split(" ")[8].charAt(0) - 48)
                .with_fin(s.split(" ")[9].charAt(0) - 48)
